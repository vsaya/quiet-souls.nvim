...
vim.api.nvim_set_hl(0, "Title", {fg = quiet_souls.soul01, bg = quiet_souls.none, underline = true})
vim.api.nvim_set_hl(0, "VertSplit", {fg = quiet_souls.fg00, bg = quiet_souls.bg00})
vim.api.nvim_set_hl(0, "WinSeparator", {fg = quiet_souls.fg00, bg = quiet_souls.bg00})
...
vim.api.nvim_set_hl(0, "markdownH1", {fg = quiet_souls.soul01, bg = quiet_souls.none, underline = true})
...
vim.api.nvim_set_hl(0, "NormalNC", {fg = quiet_souls.fg00, bg = quiet_souls.bg00})
